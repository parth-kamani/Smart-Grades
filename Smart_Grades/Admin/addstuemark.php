...
<?php
 ...
 $qw=$o;
	...
	if(isset($_POST['sub2']))
	{
		...
		$b=$_GET['q'];
		$c=$_POST['e_n'];
		$d="entmrk.php?sel=".$a."&&q=".$b."&&e=".$c."&&qh=0";
		header("location:".$d);
...
else if($type==3)
{
	...
	<?php
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Exam Marks</li>
      </ol>
    </section>
  ...
  else
  {
   load_data();
				...
				<div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="<?php echo $cname ?>" placeholder="Search" required readonly />
                </div>
                  <?php
			...
			<div style="display: block;">
				...
				<div class="form-group">
				  ...
				  <select class="form-control" id="e_n" name="e_n" required onchange="ab(this)">
                    <option selected hidden value="">Select Exam</option>
				  <?php
				$sql11 = "SELECT e_id,e_name FROM tmp_exam where cor_id=".$_GET['sel']." AND e_built=1";
