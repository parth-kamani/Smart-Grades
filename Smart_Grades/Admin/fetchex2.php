...
if(isset($_POST["query"]))
{
 ...
 $query = "
  ...
  WHERE cor_id='".$co."' AND e_built=1 AND (e_name LIKE '%".$search."%'
  ...
  $output .= '
   <tr>
	...
	<button type="button" class="btn btn-info btn-xs view_data1" data-toggle="modal" id="'.$row['e_id'].'">VIEW</button>&nbsp;&nbsp;
				  ...
				  <a class="btn btn-success btn-xs" href="editcourses.php?id='.$row['e_id'].'" 
					onclick="return confirm("sure to edit?");">EDIT</a> &nbsp;&nbsp;
				  <a class="btn btn-danger btn-xs" href="?del='.$row['e_id'].'" 
