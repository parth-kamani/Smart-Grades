            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tab">
                ...
                <tr>
				  ...
				  <a class="btn btn-success btn-xs" href="stuog.php?cr=<?php echo $value2['cl_id'];?>&&tr=<?php echo $value2['cor_id'];?>" >Select</a> &nbsp;&nbsp;
...
if(isset($_GET['tr']))
{
$query1="SELECT * FROM tbl_stuatt WHERE cor_id=".$_GET['tr']." AND s_id=".$id." AND attend=1";
					...
					{
						$query12="SELECT COUNT(a_id) as count FROM tbl_stuatt WHERE cor_id=".$_GET['tr']." AND s_id=".$id;
...
$query2="SELECT * FROM tbl_fmrk WHERE cor_id=".$_GET['tr']." AND stu_id=".$id." AND a_id IS NOT NULL";
...
//echo $query2;				
					...
					while($v2 = mysqli_fetch_array($res2))
					{
						$r2=$r2+$v2['ob_m'];
						$y2=$v2['a_id'];
						$query22="SELECT * FROM tbl_stuassi WHERE a_id=".$y2." AND cor_id=".$_GET['tr'];
...
//echo $query2;				
					...
					while($v3 = mysqli_fetch_array($res3))
					{
						...
						$r3=$r3+$v3['ob_m'];
						$y3=$v3['e_id'];
						$query32="SELECT * FROM tmp_exam WHERE e_built=1 AND e_id=".$y3." AND cor_id=".$_GET['tr'];
