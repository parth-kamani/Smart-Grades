...
if(isset($_GET['m']))
			...
			<div style="display: block;">
				...
				<div class="form-group">
				  ...
				  <?php
				$sql10 = "SELECT ch_num,ch_name FROM tbl_chapters where cor_id=".$_GET['m'];
...
$query1="SELECT * FROM tbl_stuatt WHERE cor_id=".$_GET['m']." AND ch_id=".$_GET['ch']." AND s_id=".$_GET['q']." AND attend=1";
					...
					{
						$query12="SELECT COUNT(a_id) as count FROM tbl_stuatt WHERE cor_id=".$_GET['m']." AND ch_id=".$_GET['ch']." AND s_id=".$_GET['q'];
...
$query2="SELECT * FROM tbl_stuassi WHERE ch_id=".$_GET['ch']." AND cor_id=".$_GET['m'];
...
//echo $query2;				
					...
					while($v2 = mysqli_fetch_array($res2))
					{
						$c2=$c2+$v2['a_mrk'];
						$y2=$v2['a_id'];
						$query22="SELECT * FROM tbl_fmrk WHERE a_id=".$y2." AND cor_id=".$_GET['m']." AND stu_id=".$_GET['q']." AND a_id IS NOT NULL";
...
//echo $query2;				
					...
					if($count3>0)
					{
						...
						{
							$y3=$v3['e_id'];
							$query32="SELECT * FROM tbl_stures WHERE stu_id=".$_GET['q']." AND e_id=".$y3." AND cor_id=".$_GET['m'];
							...
							if($count32>0)
							{
								while($v32 = mysqli_fetch_array($res32))
								{
									...
									if($count323>0)
									{
										...
										{
											$y31=$v323['q_queid'];
											$query3231="SELECT * FROM tbl_qdb WHERE ch_id=".$_GET['ch']." AND que_id=".$y31." AND cor_id=".$_GET['m'];
